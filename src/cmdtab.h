...
#define CMD_fixdel 57
	{(char_u *)"global",		RANGE+BANG+EXTRA+DFLALL},
#define CMD_global 58
...
#define CMD_bang 191
	{(char_u *)"<",				RANGE+COUNT+TRLBAR},
#define CMD_lshift 192
	{(char_u *)">",				RANGE+COUNT+TRLBAR},
#define CMD_rshift 193
	{(char_u *)"=",				RANGE+TRLBAR},
#define CMD_equal 194
	{(char_u *)"&",				RANGE+EXTRA},
#define CMD_and 195
	{(char_u *)"~",				RANGE+EXTRA}
#define CMD_tilde 196
#define CMD_SIZE 197
